    ...
    <h2>Reseaux sociaux</h2>
      ...
      <div className="container">
        ...
        {/* add a button with the instagram link and icon */}
          <a className="btn btn-secondary btn-sm transition-all hover:shadow-md focus:outline-none focus:ring-2 focus:ring-opacity-75" href="https://www.instagram.com/lespapillonsdulac/" target="_blank" rel="noopener noreferrer">
