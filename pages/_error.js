...
const ErrorPage = ({ statusCode }) => {
    return (
     ...
     >
         <div className="flex flex-col items-start justify-center sm:flex-row sm:space-y-0 sm:items-center sm:space-x-3">
           <p className="font-semibold text-9xl">404</p>
           <div className="">
             <h1 id="pageTitle" className="flex items-center m-0 mb-6 p-0 pb-2">
               <svg
                 aria-hidden="true"
